...
I have experience with Python, JavaScript, Git, and GitHub. I want to improve my debugging, testing, and open-source contribution skills. I prefer beginner-friendly issues with clear instructions, a small scope, and manageable code changes. I want to avoid complex issues that require extensive experience or major changes to an existing codebase.
